...
public class DSMSerialMessageToMetricTransformer implements GenericTransformer<Message, Optional<Metric>> {
    ...
    public Optional<Metric> transform(Message source) {
        ...
        if (gasMeterMatcher.find()) {
            ...
            return Optional.of(
                    new Metric("gasMeter", Double.parseDouble(volume), stringToLocalDateTime(gasTimestamp), Map.of(),
                            "m3"));
        }
        ...
        if (electricityMeterMatcher.find()) {
            ...
            return Optional.of(new Metric("electricityMeter", Double.parseDouble(value), timestamp,
        ...
        if (powerMatcher.find()) {
            ...
            return Optional.of(new Metric("electricityPower", Double.valueOf(power), timestamp,
